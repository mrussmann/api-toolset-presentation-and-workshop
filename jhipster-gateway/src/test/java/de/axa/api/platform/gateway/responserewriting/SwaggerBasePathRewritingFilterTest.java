package de.axa.api.platform.gateway.responserewriting;
...
import static de.axa.api.platform.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
